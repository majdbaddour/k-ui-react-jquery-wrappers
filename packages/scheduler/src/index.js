...
import kuiScheduler from 'kendo/js/kendo.scheduler.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoScheduler = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiScheduler.ui.Scheduler(elementNode,this.props.options);
